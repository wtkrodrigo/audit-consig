...
def render_footer():
    ...
    <div class="footer-note">
        ...
        Os dados aqui processados são protegidos pela LGPD e utilizados exclusivamente para fins de auditoria conciliatória.</p>
    </div>
    """, unsafe_allow_html=True)
...
# --- 5. MÓDULO EMPRESA ---
    ...
    if not st.session_state.at:
        ...
        if not df_empresa.empty:
            ...
            c_m3.metric("🚨 Divergentes", divs, delta_color="inverse")
